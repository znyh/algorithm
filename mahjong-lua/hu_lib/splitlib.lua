...
local M = {}
function M.get_hu_info(cards, gui_tbl, temp_gui_num)
	local gui_num = 0
	local gui_dict = {}

	if temp_gui_num and temp_gui_num >= 0 then
		gui_num = temp_gui_num
	elseif gui_tbl then
	...
	if gui_tbl and (not temp_gui_num or temp_gui_num < 0) then
			if gui_num > 0 then
